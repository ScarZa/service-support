        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" align='center'>
                <b>รถยนต์หมายเลขทะเบียน <?= $lp['license_name'];?></b><br>
                  ...
                  <td colspan="3">&nbsp;&nbsp;<input type="date" class="" name="reg_date" required=""></td>
              </tr>
              <tr>
                  <td width='50%' align="right" valign="top"><b>เลขไมล์ครั้งก่อน : </b></td>
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" name="pass_mile" placeholder="เลขครั้งที่แล้ว" value="<?= $detial_oil['this_mile']?>" required=""></td>
              </tr>
              <tr>
                  <td align="right" valign="top"><b>เลขไมล์ครั้งนี้ : </b></td>
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" name="this_mile" placeholder="เลขครั้งนี้" value="" required=""></td>
              </tr>
              <tr>
				...
				<?php	$sql = mysqli_query($db,"SELECT *  FROM ss_oil_type");
				 ...
				 while( $result = mysqli_fetch_assoc( $sql ) ){
          if($result['oil_id']==$edit_person['license_plate']){$selected='selected';}else{$selected='';}
              ...
              <tr>
                  ...
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" name="liter" placeholder="จำนวนลิตร" value="" required=""></td>
              </tr>
              <tr>
                  <td align="right" valign="top"><b>จำนวนเงิน : </b></td>
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" name="bath" placeholder="บาท" value="" required=""></td>
              </tr>
              <tr>
                  <td align="right" valign="top"><b>ค่าซ่อมบำรุง : </b></td>
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" name="maintenance" placeholder="บาท" value=""></td>
              </tr>
              <tr>
                  <td align="right" valign="top"><b>หมายเหตุ : </b></td>
                          <td colspan="3">&nbsp;&nbsp;<select name="other" id="other" required="">
                                  <option value="">เลือกประเภทการเติใน้ำมัน</option>
